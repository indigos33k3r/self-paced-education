...
# one line solution: cool but ugly
def fix_machine(debris, product):
    return product if ''.join([debris[debris.find(i)] for i in product]) == product else "Give me something that's not useless next time." 
