...
### WARNING!
###
### This question really doesn't belong here.  It
### was added in the wrong place in the course, but
### is kept here for now for consistency purposes.
###
### I (Dave) recommend skipping it.
###
